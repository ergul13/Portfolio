...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      value: "+90 538 476 42 82",
      link: "tel:+905384764282",
    },
    {
      icon: Mail,
      title: "Email Address",
      value: "akgulergul4@gmail.com",
      link: "mailto:akgulergul4@gmail.com",
    },
  ];
  ...
  const socials = [
    {
      icon: Linkedin,
      label: "LinkedIn",
      link: "https://www.linkedin.com/in/ergul13/",
    },
    {
      icon: FaXTwitter,
      label: "Twitter",
    ...
    label: "Hugging Face",
    link: "https://huggingface.co/ergulakgul",
  },
  ];
