...
const Hero = () => {
    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p className="text-xl md:text-2xl text-foreground/90">Building Neural Networks from Scratch | Java & Linux Enthusiast</p>
            <p className="text-lg md:text-xl text-muted-foreground">Computer Engineering Student @ Kayseri, Türkiye</p>
          </motion.div>
  ...
  <Button
    ...
    asChild
  >
    <a href="https://www.linkedin.com/in/ergul13/" target="_blank" rel="noopener noreferrer" className="flex items-center">
...
<MagneticButton strength={0.4}>
  <Button
    ...
    asChild
  >
    <a href="https://github.com/ergul13" target="_blank" rel="noopener noreferrer" className="flex items-center">
...
<MagneticButton strength={0.4}>
  ...
  >
    <a
      href="https://huggingface.co/ergulakgul"
      target="_blank"
...
<MagneticButton strength={0.4}>
  <Button
    ...
    asChild
  >
    <a href="https://drive.google.com/file/d/1hbJm4P5iVKie6YyCDErF08t_N7Ted_BB/view?usp=sharing" download className="flex items-center">
